                                ...
                                <div class="restaurant-card-img">
                                    <c:choose>
                                        <c:when test="${not empty restaurant.imageUrl}">
                                            <img src="${restaurant.imageUrl.startsWith('http') ? '' : pageContext.request.contextPath}${restaurant.imageUrl}" alt="<c:out value="${restaurant.name}"/>" style="width: 100%; height: 100%; object-fit: cover;" onerror="this.onerror=null; this.src='${pageContext.request.contextPath}/images/default-restaurant.png';">
                                        </c:when>
                                        <c:otherwise>
